...
namespace Microsoft.AspNet.Mvc.TagHelpers
{
    public class CacheTagHelperTest
    {
        ...
        public async Task ProcessAsync_DoesNotCache_IfDisabled()
        {
            ...
            var tagHelperOutput = new TagHelperOutput("cache", new TagHelperAttributes());
            var cacheTagHelper = new CacheTagHelper
            {
                ViewContext = GetViewContext(),
        ...
        public async Task ProcessAsync_ReturnsCachedValue_IfVaryByParamIsUnchanged()
        {
            ...
            var tagHelperOutput1 = new TagHelperOutput("cache", new TagHelperAttributes());
            ...
            var tagHelperOutput2 = new TagHelperOutput("cache", new TagHelperAttributes());
        ...
        public async Task ProcessAsync_RecalculatesValueIfCacheKeyChanges()
        {
            ...
            var tagHelperOutput1 = new TagHelperOutput("cache", new TagHelperAttributes { { "attr", "value" } });
            ...
            var tagHelperOutput2 = new TagHelperOutput("cache", new TagHelperAttributes { { "attr", "value" } });
        ...
        public async Task ProcessAsync_FlowsEntryLinkThatAllowsAddingTriggersToAddedEntry()
        {
            ...
            var tagHelperOutput = new TagHelperOutput("cache", new TagHelperAttributes { { "attr", "value" } });
